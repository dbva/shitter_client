...
public class CheckBox extends Component {
    ...
    public void render(MatrixStack matrices, int mouseX, int mouseY, float delta) {
        ...
        IFont.legacy16.drawStringWithShadow(matrices, boolSet.getName() + ": " + (boolSet.isEnabled() ? "on" : "§7off"), parent.parent.x + textOffset, parent.parent.y + parent.offset + offset + textOffset, new Color(147, 32, 32).getRGB());
